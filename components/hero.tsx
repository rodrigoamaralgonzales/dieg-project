...
export function Hero({ show = true }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-[10px] overflow-hidden bg-gradient-to-br from-background via-background to-primary/5">
      {/* Background Pattern */}
